      ...
      <div className="work__projects">
        <div className="work__project">
          ...
          <div className="work__project-description">
            <pre>
              {props.language === "ru"
                ? `Сайт социально-общественных новостей. Проект написан с использованием React, Node.js(Express) и MongoDB(Mongoose). Около 10 000 строк кода. Короткий перечень функционала:
